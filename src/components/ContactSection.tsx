...
export function ContactSection() {
  ...
  return (
    <section id="contact" ref={scope} className="section-shell noise relative bg-[#080808] px-5 py-24 md:py-32">
      <div className="relative z-10 mx-auto grid max-w-7xl gap-12 md:grid-cols-[0.9fr_1.1fr] md:items-start">
        <div className="contact-copy">
          <p className="mb-4 text-sm font-bold uppercase tracking-[0.34em] text-foleman-yellow">Contact</p>
          <h2 className="font-display text-7xl leading-none text-white md:text-9xl">Let&apos;s Talk Power</h2>
          <p className="mt-7 max-w-xl text-lg leading-8 text-white/68">
            Book Foleman Electricals for installation, maintenance, repairs, testing, and troubleshooting in Lagos or anywhere your project needs reliable power.
          </p>
          <div className="mt-10 space-y-4 text-white/74">
            <p>
              <span className="text-foleman-yellow">Phone:</span> {contact.phoneDisplay}
            </p>
            <p>
            ...
            <p>
              <span className="text-foleman-yellow">Social:</span> {contact.instagram}
            </p>
          </div>
          <a
        ...
        <form className="contact-form rounded-lg border border-white/10 bg-white/[0.045] p-5 shadow-inner-line backdrop-blur-xl md:p-8">
          <div className="grid gap-5 sm:grid-cols-2">
            {fields.map((field) => (
              <label key={field} className="block">
                <span className="mb-2 block text-sm font-bold uppercase tracking-[0.18em] text-white/54">{field}</span>
                <input
          ...
          <label className="mt-5 block">
            <span className="mb-2 block text-sm font-bold uppercase tracking-[0.18em] text-white/54">Service Type</span>
          ...
          <label className="mt-5 block">
            <span className="mb-2 block text-sm font-bold uppercase tracking-[0.18em] text-white/54">Message</span>
            <textarea
